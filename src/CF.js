...
export class CF extends ComplexDataType {
    static components = {
        Identifier: {
            defaultDataType: ST,
            dataTypes: [
        ...
        SecondAlternateFormattedText: {
            defaultDataType: FT,
            dataTypes: [{ dataType: FT, versions: ['2.7', '2.7.1', '2.8'] }],
            position: 11,
        },
    ...
    get FormattedText() {
        return this.getComponent('FormattedText');
    }

    set FormattedText(value) {
        this.setComponentValue('FormattedText', value);
    }
    ...
    get AlternateFormattedText() {
        return this.getComponent('AlternateFormattedText');
    }

    set AlternateFormattedText(value) {
        this.setComponentValue('AlternateFormattedText', value);
    }
    ...
    get SecondAlternateFormattedText() {
        return this.getComponent('SecondAlternateFormattedText');
    }

    set SecondAlternateFormattedText(value) {
        this.setComponentValue('SecondAlternateFormattedText', value);
    }
